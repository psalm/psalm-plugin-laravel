...
return RectorConfig::configure()
    ...
    ->withSkip([
        ...
        'tests/Unit/Handlers/Fixtures/MissingRoute/bootstrap/cache', // Laravel writes packages.php/services.php here when the emission fixture boots; gitignored generated output, not plugin source.
        ...
        \Rector\CodeQuality\Rector\FuncCall\SortCallLikeNamedArgsRector::class => ['tests/Unit/Handlers/Fixtures/MissingRoute'], // Sorting the named arguments back into declaration order puts the route name at offset 0, which is exactly the shape these fixtures must NOT have: they exist to prove the name is resolved by identifier rather than by position.
