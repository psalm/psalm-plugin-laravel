...
?>
--EXPECTF--
MixedAssignment on line %d: Unable to determine the type that $record is being assigned to
MixedMethodCall on line %d: Cannot determine the type of $record when calling method getRelated
