 ...
 * {@see \Psalm\LaravelPlugin\Plugin}: the map is a constant and the deduplicated array merge
 * is idempotent, so a repeated invocation over the same Codebase is a no-op.
 */
