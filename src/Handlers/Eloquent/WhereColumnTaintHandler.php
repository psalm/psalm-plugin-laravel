 ...
 * PR #1218.
 *
 * This is the 3.x (Psalm 6) port of the master handler (PR #1221); the only delta is the Psalm 6
 * RemoveTaints API, where {@see removeTaints} returns a `list<string>` of taint kinds instead of the
 * Psalm 7 int bitmask.
 */
