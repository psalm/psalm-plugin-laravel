...
- [OctaneIncompatibleBinding](docs/issues/OctaneIncompatibleBinding.md) (opt-in): `singleton()` closure resolves a request-scoped service such as Request, Session, or Auth
